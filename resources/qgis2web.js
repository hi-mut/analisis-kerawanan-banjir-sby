...
map.getView().fit([12528850.299074, -821957.628019, 12567302.366698, -795147.107311], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Resiko Bencana Banjir Kawasan Surabaya</h2>';
        return titleElement;
    })(),
